...
public class PruneEmptyMinus extends RelRule<PruneEmptyMinus.Config> {
	...
	public interface Config extends EmptyConfig {
		...
		default RelRule.OperandTransform operandSupplier() {
			return s_2 -> s_2.operand(LogicalMinus.class).predicate(minus -> !minus.all).inputs(s_0 -> s_0.operand(LogicalValues.class).noInputs(), s_1 -> s_1.operand(RelNode.class).anyInputs());
		}
